    ...
    grid-cols-5 m-auto items-center justify-center'>
      ...
      <div className=''>
        ...
        <p className='text-white pb-[13px] opacity-70 leading-7'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt quibusdam corporis ipsa reprehenderit dolorem neque!
        </p>
      </div>
      ...
      <div className='grid'>
        ...
        <div className='grid gap-3'>
          <small className='text-[14px] text-white'>escavanessa@gmail.com</small>
          <div className='icons flex gap-4 py-[1rem]'>
          <AiFillInstagram className='bg-white p-[8px] h-[35px] w-[35px] rounded-full icon
          text-blueColor'/>
          <FaGithub className='bg-white p-[8px] h-[35px] w-[35px] rounded-full icon
          text-blueColor'/>
          <FaLinkedin className='bg-white p-[8px] h-[35px] w-[35px] rounded-full icon
          text-blueColor'/>
          </div>
        </div>
      </div>
